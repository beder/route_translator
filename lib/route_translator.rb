...
module RouteTranslator
  ...
  Configuration = Struct.new(:force_locale, :generate_unlocalized_routes, :translation_file, :locale_param_key, :generate_unnamed_unlocalized_routes, :exclude_locale_from_paths)
